...
public class Scene1Pressed : MonoBehaviour
{
    ...
    void Start()
    {
        GetComponent<Interactable>().OnClick.AddListener(saveSceneTwoandLoadSceneOne);
    }

    public void saveSceneTwoandLoadSceneOne()
    {
